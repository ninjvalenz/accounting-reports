...
function ProductionCategoryWise({ availableMonths }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/production-category-wise`, {
        params: { 
  ...
  return (
    <div className="dashboard-card">
      <div className="card-header">
        <h2>Production Category Wise</h2>
      </div>
...
export default ProductionCategoryWise;
